...
export const createCapability = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, 'Capability created successfully', capability, {}));
});
...
export const getAllCapabilities = asyncHandler(async (_req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, 'Capabilities fetched successfully', capabilities, {}));
});
...
export const getCapabilityById = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, 'Capability fetched successfully', capability, {}));
});
...
export const updateCapability = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, 'Capability updated successfully', capability, {}));
});
...
export const createCapabilityFunction = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, 'Capability function created successfully', fn, {}));
});
...
export const getCapabilityFunctions = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, 'Capability functions fetched successfully', functions, {}));
});
...
export const updateCapabilityFunction = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, 'Capability function updated successfully', fn, {}));
});
...
export const deleteCapabilityFunction = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, 'Capability function deleted successfully', {}, {}));
});
...
export const updateAvailableBotCapabilities = asyncHandler(async (req, res) => {
  ...
  const bot = await adminBotService.syncAvailableBotCapabilities(
    availableBotId as string,
    data.capabilityIds
  );
  return res
    .status(200)
    .json(new ApiResponse(200, 'Available bot capabilities updated successfully', bot, {}));
});
...
export const toggleAvailableBot = asyncHandler(async (req, res) => {
  ...
  const bot = await adminBotService.toggleAvailableBot(
    availableBotId as string,
    !existing.isActive
  );
  return res
    ...
    .json(
      new ApiResponse(
        200,
        `Bot ${bot.isActive ? 'activated' : 'deactivated'} successfully`,
        bot,
        {}
      )
    );
...
export const deleteAvailableBot = asyncHandler(async (req, res) => {
  ...
  if (botCount > 0)
    throw new ApiError(409, `Cannot delete: ${botCount} bot(s) are using this template`);
